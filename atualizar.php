...
<?php echo !empty($ingredientesErro)?'error':'';?>
			...
			<div class="col-sm-10">          
				<textarea id="sbnm" name="igrd" rows="<?php echo $lin; ?>" cols="<?php echo $col; ?>"><?php echo !empty($ingredientes)?$ingredientes:'';?></textarea>
...
<?php echo !empty($modopreparoErro)?'error':'';?>
			...
			<div class="col-sm-10">          
				<textarea name="modopreparo" id="apld" rows="<?php echo $lin; ?>" cols="<?php echo $col; ?>"><?php echo !empty($modopreparo)?$modopreparo:'';?></textarea>
